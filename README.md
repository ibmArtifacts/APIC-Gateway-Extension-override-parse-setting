...
After uploading the gateway-extension to the gateway from the topology, and waiting about 2 to 5 minutes, the size will be updated:  
<img width="849" height="523" alt="image" src="https://github.com/user-attachments/assets/18e7bb08-da16-4447-a9cd-2b21a55de60e" />

The [gw-extension.zip](https://github.com/ibmArtifacts/APIC-Gateway-Extension-override-parse-setting/raw/refs/heads/main/gw-extension.zip) is ready to be uploaded to the gateway in the topology to be used.
